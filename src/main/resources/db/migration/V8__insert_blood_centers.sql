...
VALUES ('Rua Castro Alves 131 - Aclimação - São Paulo - SP 13424-367', 'Aclimação', '-23.567073416288615',
        '-46.63855151990882', 'CENTRO', 'SP');

WITH bc AS (
INSERT
INTO tb_blood_centers (blood_center_id, name, blood_center_address_id, operation)
VALUES (gen_random_uuid(), 'Hospital A.C. Camargo - São Paulo - SP', currval('tb_blood_center_addresses_blood_center_address_id_seq'), 'seg à sex - 08h às 17h')
...
INSERT INTO tb_blood_center_addresses (full_address, bairro, latitude, longitude, zone, estado)
VALUES ('Rua Castro Alves 60 - Aclimação São Paulo - SP 01532-000', 'Aclimação', '-23.567427117335463',
        '-46.63911057088798', 'CENTRO', 'SP');

WITH bc AS (
INSERT
INTO tb_blood_centers (blood_center_id, name, blood_center_address_id, operation)
VALUES (gen_random_uuid(), 'Hospital do Servidor Publico Municipal - São Paulo - SP', currval('tb_blood_center_addresses_blood_center_address_id_seq'), 'seg à sex - 08h às 12h')
    RETURNING blood_center_id
    )
INSERT
INTO tb_blood_center_phone (blood_center_id, phone)
...
INSERT INTO tb_blood_center_addresses (full_address, bairro, latitude, longitude, zone, estado)
VALUES ('Rua Maestro Cardim 1041 - Bela Vista São Paulo - SP 01323-130', 'Bela Vista', '-23.570083235797107',
        '-46.64191015897977', 'CENTRO', 'SP');

WITH bc AS (
INSERT
INTO tb_blood_centers (blood_center_id, name, blood_center_address_id, operation)
VALUES (gen_random_uuid(), 'Hospital Beneficência Portuguesa de São Paulo - SP', currval('tb_blood_center_addresses_blood_center_address_id_seq'), 'seg à sex- 7h às 18h/ sab - 7h às 12h')
    RETURNING blood_center_id
    )
INSERT
INTO tb_blood_center_phone (blood_center_id, phone)
...
INSERT INTO tb_blood_center_addresses (full_address, bairro, latitude, longitude, zone, estado)
VALUES ('Rua Dona Adma Jafet 91 - Bela Vista São Paulo - SP 01308-050', 'Bela Vista', '-23.557117079917173',
        '-46.65464558721673', 'CENTRO', 'SP');

WITH bc AS (
INSERT
INTO tb_blood_centers (blood_center_id, name, blood_center_address_id, operation)
VALUES (gen_random_uuid(), 'Hospital Sírio-Libanês - Bela Vista - SP', currval('tb_blood_center_addresses_blood_center_address_id_seq'), 'seg à sex - 06h30 às 22h/ sab - 06h30 às 18h/ dom - 07h às 12h30')
    RETURNING blood_center_id
    )
INSERT
INTO tb_blood_center_phone (blood_center_id, phone)
...
INSERT INTO tb_blood_center_addresses (full_address, bairro, latitude, longitude, zone, estado)
VALUES ('Rua João Julião 331 - Bela Vista São Paulo - SP 01323-020', 'Bela Vista', '-23.56858767381254',
        '-46.643212442403595', 'CENTRO', 'SP');

WITH bc AS (
INSERT
INTO tb_blood_centers (blood_center_id, name, blood_center_address_id, operation)
VALUES (gen_random_uuid(), 'Instituto HOC - Bela Vista - SP', currval('tb_blood_center_addresses_blood_center_address_id_seq'), 'seg à sex - 07h às 22h/ sab - 08h às 15h')
    RETURNING blood_center_id
    )
INSERT
INTO tb_blood_center_phone (blood_center_id, phone)
...
INSERT INTO tb_blood_center_addresses (full_address, bairro, latitude, longitude, zone, estado)
VALUES ('Avenida Dr. Enéas Carvalho de Aguiar 155 - Cerqueira César São Paulo - SP 05403-000', 'Cerqueira Cesar',
        '-23.557586487113266', '-46.66896090232076', 'CENTRO', 'SP');

WITH bc AS (
INSERT
INTO tb_blood_centers (blood_center_id, name, blood_center_address_id, operation)
VALUES (gen_random_uuid(), 'Pró-Sangue - São Paulo (Unidade Clínicas) - SP', currval('tb_blood_center_addresses_blood_center_address_id_seq'), 'seg à sex - 08h às 17h30/ sab - 08h às 16h')
    RETURNING blood_center_id
    )
INSERT
INTO tb_blood_center_phone (blood_center_id, phone)
...
INSERT INTO tb_blood_center_addresses (full_address, bairro, latitude, longitude, zone, estado)
VALUES ('Rua Conselheiro Brotero 1486 - Higienópolis São Paulo - SP 01232-010', 'Higienópolis', '-23.539114645395884',
        '-46.661836802917456', 'OESTE', 'SP');

WITH bc AS (
INSERT
INTO tb_blood_centers (blood_center_id, name, blood_center_address_id, operation)
VALUES (gen_random_uuid(), 'Hospital Samaritano Higienópolis - São Paulo - SP', currval('tb_blood_center_addresses_blood_center_address_id_seq'), 'Atendimento 24h')
    RETURNING blood_center_id
    )
INSERT
INTO tb_blood_center_phone (blood_center_id, phone)
...
INSERT INTO tb_blood_center_addresses (full_address, bairro, latitude, longitude, zone, estado)
VALUES ('Avenida Brigadeiro Luís Antônio 2533 - Jardim Paulista São Paulo - SP 01401-000', 'Jardim Paulista',
        '-23.569579924867337', '-46.6505196249348', 'OESTE', 'SP');
...
INSERT INTO tb_blood_center_addresses (full_address, bairro, latitude, longitude, zone, estado)
VALUES ('Rua Peixoto Gomide 625 - Jardim Paulista São Paulo - SP 01409-001', 'Jardim Paulista', '-23.559614317466146',
        '-46.65533428197777', 'OESTE', 'SP');

WITH bc AS (
INSERT
INTO tb_blood_centers (blood_center_id, name, blood_center_address_id, operation)
VALUES (gen_random_uuid(), 'Serviço de Hemoterapia Hospital 9 de Julho - SP', currval('tb_blood_center_addresses_blood_center_address_id_seq'), 'seg à sex - 08h às 17h/ sab  - 08h às 12h')
    RETURNING blood_center_id
    )
INSERT
INTO tb_blood_center_phone (blood_center_id, phone)
...
INSERT INTO tb_blood_center_addresses (full_address, bairro, latitude, longitude, zone, estado)
VALUES ('Rua Barão de Iguape 212 - Liberdade São Paulo - SP 01507-000', 'Liberdade', '-23.558431389199885',
        '-46.63489478378197', 'OESTE', 'SP');

WITH bc AS (
INSERT
INTO tb_blood_centers (blood_center_id, name, blood_center_address_id, operation)
VALUES (gen_random_uuid(), 'Hemocentro São Lucas - Liberdade - SP', currval('tb_blood_center_addresses_blood_center_address_id_seq'), 'seg à sex - 08h às 16h30')
    RETURNING blood_center_id
    )
INSERT
INTO tb_blood_center_phone (blood_center_id, phone)
...
INSERT INTO tb_blood_center_addresses (full_address, bairro, latitude, longitude, zone, estado)
VALUES ('Avenida Albert Einstein 627 - Morumbi São Paulo - SP 05652-900', 'Morumbi', '-23.5990693521708',
        '-46.71489646282873', 'OESTE', 'SP');

WITH bc AS (
INSERT
INTO tb_blood_centers (blood_center_id, name, blood_center_address_id, operation)
VALUES (gen_random_uuid(), 'Banco de Sangue do Hospital Albert Einstein - São Paulo - SP', currval('tb_blood_center_addresses_blood_center_address_id_seq'), 'seg à sex - 08h às 17h/ sab  - 08h às 16h')
    RETURNING blood_center_id
    )
INSERT
INTO tb_blood_center_phone (blood_center_id, phone)
...
INSERT INTO tb_blood_center_addresses (full_address, bairro, latitude, longitude, zone, estado)
VALUES ('Rua Tomás Carvalhal 711 - Paraíso São Paulo - SP 04006-002', 'Paraíso', '-23.577780025362248',
        '-46.6478920589179', 'SUL', 'SP');

WITH bc AS (
INSERT
INTO tb_blood_centers (blood_center_id, name, blood_center_address_id, operation)
VALUES (gen_random_uuid(), 'Banco de Sangue de São Paulo - Jd Paulista - SP', currval('tb_blood_center_addresses_blood_center_address_id_seq'), 'seg à sex - 07h às 18h/ sab - 07h às 18h/ dom - 07h às 18h')
    RETURNING blood_center_id
    )
INSERT
INTO tb_blood_center_phone (blood_center_id, phone)
...
INSERT INTO tb_blood_center_addresses (full_address, bairro, latitude, longitude, zone, estado)
VALUES ('Rua tavares bastos 425-CEP 05012-020- Vila Pompéia-São Paulo- SP', 'Pompeia', '-23.534266051569105',
        '-46.68697712877745', 'OESTE', 'SP');
...
INSERT INTO tb_blood_center_addresses (full_address, bairro, latitude, longitude, zone, estado)
VALUES ('Rua Iguatinga 382/386 - Santo Amaro São Paulo - SP 04744-040', 'Santo Amaro', '-23.65595463737257',
        '-46.7055329930984', 'SUL', 'SP');

WITH bc AS (
INSERT
INTO tb_blood_centers (blood_center_id, name, blood_center_address_id, operation)
VALUES (gen_random_uuid(), 'Banco de Sangue Paulista - São Paulo - SP', currval('tb_blood_center_addresses_blood_center_address_id_seq'), 'seg à sex - 08h às 16h30/ sab  - 08h às 16h')
    RETURNING blood_center_id
    )
INSERT
INTO tb_blood_center_phone (blood_center_id, phone)
...
INSERT INTO tb_blood_center_addresses (full_address, bairro, latitude, longitude, zone, estado)
VALUES ('Avenida Celso Garcia 4815 - Tatuapé São Paulo - SP 03085-030', 'Tatuapé', '-23.532708968779815',
        '-46.56652763873117', 'LESTE', 'SP');

WITH bc AS (
INSERT
INTO tb_blood_centers (blood_center_id, name, blood_center_address_id, operation)
VALUES (gen_random_uuid(), 'Hospital Municipal Doutor Carmino Caricchio de Tatuapé - São Paulo - SP', currval('tb_blood_center_addresses_blood_center_address_id_seq'), 'Atendimento 24h')
    RETURNING blood_center_id
    )
INSERT
INTO tb_blood_center_phone (blood_center_id, phone)
...
INSERT INTO tb_blood_center_addresses (full_address, bairro, latitude, longitude, zone, estado)
VALUES ('Rua Harry Dannenberg 473 - Vila Carmosina São Paulo - SP 08270-010', 'Vila Carmosina', '-23.554379709015073',
        '-46.46397512776769', 'LESTE', 'SP');

WITH bc AS (
INSERT
INTO tb_blood_centers (blood_center_id, name, blood_center_address_id, operation)
VALUES (gen_random_uuid(), 'Hospital Santa Marcelina - São Paulo - SP', currval('tb_blood_center_addresses_blood_center_address_id_seq'), 'seg à sex - 07h às 16h/ sab  - 07h às 12h')
    RETURNING blood_center_id
    )
INSERT
INTO tb_blood_center_phone (blood_center_id, phone)
...
INSERT INTO tb_blood_center_addresses (full_address, bairro, latitude, longitude, zone, estado)
VALUES ('Rua Dr. Diogo de Faria 824 - Vila Clementino São Paulo - SP 04037-002', 'Vila Clementino',
        '-23.595512405234825', '-46.644655093772315', 'SUL', 'SP');

WITH bc AS (
INSERT
INTO tb_blood_centers (blood_center_id, name, blood_center_address_id, operation)
VALUES (gen_random_uuid(), 'Hemocentro HSP Unifesp - São Paulo - SP', currval('tb_blood_center_addresses_blood_center_address_id_seq'), 'seg à sex - 08h às 17h30/ sab  - 08h às 12h')
    RETURNING blood_center_id
    )
INSERT
INTO tb_blood_center_phone (blood_center_id, phone)
...
INSERT INTO tb_blood_center_addresses (full_address, bairro, latitude, longitude, zone, estado)
VALUES ('Rua Pedro de Toledo 1800 - Vila Clementino São Paulo - SP 04039-000', 'Vila Clementino', '-23.597365411275334',
        '-46.654469818169524', 'SUL', 'SP');

WITH bc AS (
INSERT
INTO tb_blood_centers (blood_center_id, name, blood_center_address_id, operation)
VALUES (gen_random_uuid(), 'Iamspe - (HSPE) Banco de Sangue do Hospital do Servidor Público Estadual - SP', currval('tb_blood_center_addresses_blood_center_address_id_seq'), 'seg à sex - 09h às 16h/ sab  - 08h às 16h')
    RETURNING blood_center_id
    )
INSERT
INTO tb_blood_center_phone (blood_center_id, phone)
...
INSERT INTO tb_blood_center_addresses (full_address, bairro, latitude, longitude, zone, estado)
VALUES ('Rua Marquês de Itu 579 - Vila Buarque São Paulo - SP 01223-001', 'Vila Buarque', '-23.54382250385755',
        '-46.64997768842207', 'CENTRO', 'SP');

WITH bc AS (
INSERT
INTO tb_blood_centers (blood_center_id, name, blood_center_address_id, operation)
VALUES (gen_random_uuid(), 'Hemocentro da Santa Casa de São Paulo - São Paulo - SP', currval('tb_blood_center_addresses_blood_center_address_id_seq'), 'seg à sex - 07h às 17h/ sab  - 07h às 15h')
    RETURNING blood_center_id
    )
INSERT
INTO tb_blood_center_phone (blood_center_id, phone)
...
INSERT INTO tb_blood_center_addresses (full_address, bairro, latitude, longitude, zone, estado)
VALUES ('Avenida Dr. Dante Pazzanese 500 - Vila Mariana São Paulo - SP 04012-909', 'Vila Mariana',
        '-23.585324874667986', '-46.651334423062245', 'SUL', 'SP');

WITH bc AS (
INSERT
INTO tb_blood_centers (blood_center_id, name, blood_center_address_id, operation)
VALUES (gen_random_uuid(), 'Pró-Sangue - Hemocentro de São Paulo - Posto Dante Pazzanese', currval('tb_blood_center_addresses_blood_center_address_id_seq'), 'seg à sex - 08h às 12h30/ sab  - 08h às 13h')
    RETURNING blood_center_id
    )
INSERT
INTO tb_blood_center_phone (blood_center_id, phone)
...
INSERT INTO tb_blood_center_addresses (full_address, bairro, latitude, longitude, zone, estado)
VALUES ('Rua Dr. Alceu de Campos Rodrigues 46  - Vila Nova Conceição São Paulo - SP 04544-000', 'Vila Nova Conceição',
        '-23.58981837486613', '-46.6728595446497', 'SUL', 'SP');
...
INSERT INTO tb_blood_center_addresses (full_address, bairro, latitude, longitude, zone, estado)
VALUES ('Avenida Santo Amaro 2468 - Vila Olímpia São Paulo - SP 04556-100', 'Vila Olímpia', '-23.605317844976053',
        '-46.67599075999036', 'SUL', 'SP');

WITH bc AS (
INSERT
INTO tb_blood_centers (blood_center_id, name, blood_center_address_id, operation)
VALUES (gen_random_uuid(), 'Hemocentro São Lucas - Vila Olimpia - São Paulo - SP', currval('tb_blood_center_addresses_blood_center_address_id_seq'), 'seg à sex - 09h às 17h/ sab  - 10h às 14h')
    RETURNING blood_center_id
    )
INSERT
INTO tb_blood_center_phone (blood_center_id, phone)
...
VALUES ('Avenida da Saúde 415 Jardim - Nossa Sra. de Fatima Americana - SP 13478-640', 'Americana',
        '-22.742282201760016', '-47.308764315828164', 'SP');
...
VALUES ('Avenida Rua Arthur Ferreira da Costa 330 - Aviacao Araçatuba - SP 16055-500', 'Araçatuba',
        '-21.19293120858644', '-50.431417305009376', 'SP');
...
VALUES ('Avenida São Francisco de Assis 260 - Cidade Universitária Bragança Paulista - SP 12916-542',
        'Bragança Paulista', '-22.979724704042788', '-46.534414541732176', 'SP');
...
VALUES ('Alameda Rodrigo de Brum 1989 - Ermelino Matarazzo São Paulo - SP 03807-230', 'Ermelino Matarazzo',
        '-23.499774024355375', '-46.472329843727756', 'SP');
...
VALUES ('Rua  Simão dos Santos Gomes 266 - Jardim Santista Fernandópolis - SP 15600-000', 'Fernandópolis',
        '-20.29486771040057', '-50.24738462170416', 'SP');
...
VALUES ('Rua Silva Jardim 1700 - Alto Piracicaba - SP 13419-140 (Antigo prédio do ‘Saúde Inteligente’ dentro do complexo da Santa Casa)',
        'Piracicaba', '-22.73613701916124', '-47.64196761610465', 'SP');
...
VALUES ('Avenida Cel. José Soares Marcondes 2063 - Uep1-S.1 Pres. Prudente - SP 19010-089', 'Presidente Prudente',
        '-22.12896941003021', '-51.3916658583481', 'SP');
...
VALUES ('Rua Wenceslau Braz 5 - Vila Euclides Pres. Prudente - SP 19014-030', 'Presidente Prudente',
        '-22.12947180726716', '-51.392401374910314', 'SP');
...
VALUES ('Rua Tenente Catão Roxo 2501 - Vila Monte Alegre Ribeirão Preto - SP 14051-140', 'Ribeirão Preto',
        '-21.160318928566696', '-47.848559714005695', 'SP');
...
VALUES ('Rua Paulino Botelho de Abreu Sampaio 535 - Jardim Pureza São Carlos - SP 13561-060', 'São Carlos',
        '-22.01196744261255', '-47.901116100176814', 'SP');
...
VALUES ('Avenida João Osório 701 - CENTRO São João da Boa Vista - SP 13870-251', 'São João da Boa Vista',
        '-21.9821585441285', '-46.79584175209147', 'SP');
...
VALUES ('Avenida Jamil Feres Kfouri 80 - Jardim Panorama São José do Rio Preto - SP 15091-240', 'São José do Rio Preto',
        '-20.827110447106094', '-49.40010608702224', 'SP');
...
VALUES ('Rua Luíz Vaz de Camões 3150 - Vila Redentora São José do Rio Preto - SP 15015-750', 'São José do Rio Preto',
        '-20.82179739839853', '-49.390010276934014', 'SP');
...
VALUES ('Rua Antônio Saes 425 - CENTRO São José dos Campos - SP 12210-040', 'São José do Rio Preto',
        '-23.187053402994582', '-45.88174780232667', 'SP');
...
VALUES ('Avenida Comendador Pereira Inácio 564 - Jardim Vergueiro Sorocaba - SP 18030-005', 'Sorocaba',
        '-23.510516913126096', '-47.45684417428096', 'SP');
...
VALUES ('Avenida Ibirama 1214 - Jardim Sao Judas Tadeu Taboão da Serra - SP 06785-300', 'Taboão da Serra',
        '-23.640469997941512', '-46.80987265181835', 'SP');
...
VALUES ('Rua Pedro Jacobucci 440 - Jardim das AmericasSão Bernardo do Campo - SP 09725-750', 'São Bernardo do Campo',
        '-23.698708951024127', '-46.555513588824205', 'SP');
...
VALUES ('Rua Mediterrâneo 470 - Jardim do Mar São Bernardo do Campo - SP 09750-420', 'São Bernardo do Campo',
        '-23.69120807867155', '-46.55410337422158', 'SP');
